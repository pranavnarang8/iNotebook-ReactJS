...
const Notes = (props) => {
  ...
  //useEffect s used here as a componentDidMount(), so that the notes are fetched after the rendering of the component
  useEffect(()=>{
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form className="my-3">
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" id="etitle" name="etitle" aria-describedby="emailHelp" onChange={onChange} value={note.etitle} minLength={5}
                  required/>
                </div>
                <div className="mb-3">
            ...
            <div className="modal-footer">
              ...
              <button disabled={note.etitle.length<3 || note.edescription.length<6} type="button"
